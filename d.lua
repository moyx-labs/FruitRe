...
GemButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Gray base color
GemButton.Text = "Gem"
...
-- Gem Pulse Glow Animation (for disabled state)
if not gemEnabled then
    local function animateGemPulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(GemButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)}) -- Pulse to pastel red
        tween:Play()
    end
    animateGemPulseGlow()
end
...
CoinsButton.BackgroundColor3 = Color3.fromRGB(60, 60, 60) -- Gray base color
...
-- Coins Pulse Glow Animation (for disabled state)
if not coinsEnabled then
    local function animateCoinsPulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(CoinsButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)}) -- Pulse to pastel red
        tween:Play()
    end
