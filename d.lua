...
-- [Previous code unchanged up to checkSupportedMap]
...
local foodEnabled = scriptStatus == "w" and hasFood
local lvlEnabled = scriptStatus == "w" and hasLvl
local summonsEnabled = scriptStatus == "w" and hasSummons
...
local foodDisableReason = scriptStatus == "p" and "( Patched )" or not hasFood and "( No Access )" or ""
local lvlDisableReason = scriptStatus == "p" and "( Patched )" or not hasLvl and "( No Access )" or ""
local summonsDisableReason = scriptStatus == "p" and "( Patched )" or not hasSummons and "( No Access )" or ""
...
GemButton.Position = UDim2.new(0.5, -2 * (buttonWidth + spacing), 0, 80) 
...
if not gemEnabled then
    local function animateGemPulseGlow()
        ...
        local tween = TweenService:Create(GemButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateGemPulseGlow()
end
...
GemReasonLabel.Position = UDim2.new(0.5, -2 * (buttonWidth + spacing), 0, 110) 
...
CoinsButton.Position = UDim2.new(0.5, -1 * (buttonWidth + spacing), 0, 80) 
...
if not coinsEnabled then
    local function animateCoinsPulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(CoinsButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
...
CoinsReasonLabel.Position = UDim2.new(0.5, -1 * (buttonWidth + spacing), 0, 110) 
...
GetFoodButton.Position = UDim2.new(0.5, 0 * (buttonWidth + spacing), 0, 80) 
...
local GetFoodUICorner = Instance.new("UICorner")
GetFoodUICorner.CornerRadius = UDim.new(0, 8)
GetFoodUICorner.Parent = GetFoodButton

if not foodEnabled then
    local function animateGetFoodPulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(GetFoodButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateGetFoodPulseGlow()
end

local GetFoodReasonLabel = Instance.new("TextLabel")
GetFoodReasonLabel.Size = UDim2.new(0, buttonWidth, 0, 15)
GetFoodReasonLabel.Position = UDim2.new(0.5, 0 * (buttonWidth + spacing), 0, 110) 
...
GetFoodReasonLabel.TextSize = 8
GetFoodReasonLabel.Font = Enum.Font.SourceSans
...
FeedLvlButton.Position = UDim2.new(0.5, 1 * (buttonWidth + spacing), 0, 80) 
...
local FeedLvlUICorner = Instance.new("UICorner")
FeedLvlUICorner.CornerRadius = UDim.new(0, 8)
FeedLvlUICorner.Parent = FeedLvlButton

if not lvlEnabled then
    local function animateFeedLvlPulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(FeedLvlButton, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateFeedLvlPulseGlow()
end

local FeedLvlReasonLabel = Instance.new("TextLabel")
FeedLvlReasonLabel.Size = UDim2.new(0, buttonWidth, 0, 15)
FeedLvlReasonLabel.Position = UDim2.new(0.5, 1 * (buttonWidth + spacing), 0, 110)
...
FeedLvlReasonLabel.TextSize = 8
FeedLvlReasonLabel.Font = Enum.Font.SourceSans
FeedLvlReasonLabel.TextXAlignment = Enum.TextXAlignment.Center
FeedLvlReasonLabel.Parent = Frame

-- Second Row: Summon 150, Summon 300, Summon 500 (3 buttons, centered)
local Summon150Button = Instance.new("TextButton")
Summon150Button.Size = UDim2.new(0, buttonWidth, 0, buttonHeight)
Summon150Button.Position = UDim2.new(0.5, -1 * (buttonWidth + spacing), 0, 80 + rowHeight) 
...
local Summon150UICorner = Instance.new("UICorner")
Summon150UICorner.CornerRadius = UDim.new(0, 8)
Summon150UICorner.Parent = Summon150Button

if not summonsEnabled then
    local function animateSummon150PulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(Summon150Button, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateSummon150PulseGlow()
end

local Summon150ReasonLabel = Instance.new("TextLabel")
Summon150ReasonLabel.Size = UDim2.new(0, buttonWidth, 0, 15)
Summon150ReasonLabel.Position = UDim2.new(0.5, -1 * (buttonWidth + spacing), 0, 110 + rowHeight) 
...
Summon150ReasonLabel.TextSize = 8
Summon150ReasonLabel.Font = Enum.Font.SourceSans
Summon150ReasonLabel.TextXAlignment = Enum.TextXAlignment.Center
...
Summon300Button.Position = UDim2.new(0.5, 0 * (buttonWidth + spacing), 0, 80 + rowHeight)
...
local Summon300UICorner = Instance.new("UICorner")
Summon300UICorner.CornerRadius = UDim.new(0, 8)
Summon300UICorner.Parent = Summon300Button

if not summonsEnabled then
    local function animateSummon300PulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(Summon300Button, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateSummon300PulseGlow()
end

local Summon300ReasonLabel = Instance.new("TextLabel")
Summon300ReasonLabel.Size = UDim2.new(0, buttonWidth, 0, 15)
Summon300ReasonLabel.Position = UDim2.new(0.5, 0 * (buttonWidth + spacing), 0, 110 + rowHeight) 
...
Summon300ReasonLabel.TextSize = 8
Summon300ReasonLabel.Font = Enum.Font.SourceSans
Summon300ReasonLabel.TextXAlignment = Enum.TextXAlignment.Center
...
Summon500Button.Position = UDim2.new(0.5, 1 * (buttonWidth + spacing), 0, 80 + rowHeight) 
...
local Summon500UICorner = Instance.new("UICorner")
Summon500UICorner.CornerRadius = UDim.new(0, 8)
Summon500UICorner.Parent = Summon500Button

if not summonsEnabled then
    local function animateSummon500PulseGlow()
        local tweenInfo = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true)
        local tween = TweenService:Create(Summon500Button, tweenInfo, {BackgroundColor3 = Color3.fromRGB(43, 36, 37)})
        tween:Play()
    end
    animateSummon500PulseGlow()
end

local Summon500ReasonLabel = Instance.new("TextLabel")
Summon500ReasonLabel.Size = UDim2.new(0, buttonWidth, 0, 15)
Summon500ReasonLabel.Position = UDim2.new(0.5, 1 * (buttonWidth + spacing), 0, 110 + rowHeight)
...
Summon500ReasonLabel.TextSize = 8
Summon500ReasonLabel.Font = Enum.Font.SourceSans
...
local statusColor = scriptStatus == "w" and Color3.fromRGB(150, 255, 150) or Color3.fromRGB(255, 150, 150)
...
local function applyHoverEffect(button, enabled)
...
applyHoverEffect(GemButton, gemEnabled)
applyHoverEffect(CoinsButton, coinsEnabled)
applyHoverEffect(GetFoodButton, foodEnabled)
applyHoverEffect(FeedLvlButton, lvlEnabled)
applyHoverEffect(Summon150Button, summonsEnabled)
applyHoverEffect(Summon300Button, summonsEnabled)
applyHoverEffect(Summon500Button, summonsEnabled)
